---
title: "The Mystery of Folders: How to Easily Install and Use Any Open Source Program from GitHub"
description: "Struggling with GitHub projects? Learn how to turn code repositories into working apps on your machine and understand the difference between Releases and Source Code."
...
2. Look at the right-hand side of the page for a section named **Releases**.
3. You will see a version number (e.g., **v1.0.0**). Click on it.
4. A list of files will appear; look for the one that matches your system:
...
1. **The Magic File (README.md):** Always scroll down to the bottom of the page. You will find a file explaining everything. Look for **Installation** or **Usage** sections. This is the program's manual.
2. **Download the Folder:** Click the green **Code** button and select **Download ZIP**. Extract the folder on your computer.
3. **Use the Terminal:** You will need the command window we discussed earlier. Usually, the developer asks you to run a simple command to install requirements:
   * `pip install -r requirements.txt` (for Python programs).
   * `npm install` (for JavaScript programs).
